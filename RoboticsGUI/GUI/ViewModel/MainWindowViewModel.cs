...
namespace Robotics.GUI.ViewModel
{
    internal class MainWindowViewModel : BaseViewModel, IDisposable
    {
        ...
        RelayCommand _T1Plat1Led = null;
        RelayCommand _T1Plat2Led = null;
        RelayCommand _T1Obs1Led = null;
        RelayCommand _T1Obs2Led = null;
        RelayCommand _T1StartLed = null;
        ...
        RelayCommand _T2HoverLed = null;
        RelayCommand _T2Plat1Led = null;
        RelayCommand _T2Plat2Led = null;
        RelayCommand _T2Obs1Led = null;
        RelayCommand _T2Obs2Led = null;
        RelayCommand _T2StartLed = null;
        ...
        public TeamDataModel Team1 { get; } = new TeamDataModel("Team 1",22,24,26,28,30,32,2,3);
        public TeamDataModel Team2 { get; } = new TeamDataModel("Team 2",23,25,27,29,31,33,2,3);
