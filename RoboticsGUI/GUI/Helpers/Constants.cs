...
namespace Robotics.GUI.Helpers
{
    public static class Constants
    {
        ...
        public const short blimf = 36; //Front Limit Switch
        public const short blimb = 37; //Back Limit Switch

        public const short limitSwitchPort = 4; //port 4 maps to pins 32-39
